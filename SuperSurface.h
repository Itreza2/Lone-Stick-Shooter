...
struct SuperSurface : public SDL_Surface
{
	...
	*/
	void printIso(int x, int y, SDL_Surface* dest, unsigned int* hmap, bool flip = false, unsigned int height = 1, bool vertical = true);
	...
	* @param height the height of the lowest row of pixels of the printed Surface
	*/
	void printRot(int x, int y, int angle, SDL_Surface* dest, unsigned int* hmap, bool flip = false, unsigned int height = 1);
};